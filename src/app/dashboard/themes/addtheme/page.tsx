      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Upload custom themes to personalize your experience. Themes are applied instantly across
          ...
          <TabsContent value="design" className="mt-0">
            <Card className="border-2">
              <CardHeader>
                ...
                <CardDescription>
                  Learn how to create custom themes for your workspace
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <CardContent className="flex flex-col md:flex-row items-center justify-between p-8">
            <div className="flex-1">
              ...
              <p className="text-muted-foreground max-w-xl">
                Create and share your custom themes with the community. Showcase your design skills
                and help others personalize their experience.
              </p>
            </div>
