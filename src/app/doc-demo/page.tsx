...
export default function Documentation() {
                        ...
                        <div className="prose max-w-none">
                            ...
                            <section id="overview">
                                ...
                                <div className="space-y-4 text-gray-600">
                                    <p>
                                        The Next.js CMS is a modern content management system built with cutting-edge web technologies
                                        to provide a seamless website creation and management experience.
                                    </p>
                                    ...
                                    {[
                                        {
                                            ...
                                            content: 'Secure user registration and login flow with MongoDB storage and JWT authentication'
                                        },
                                        {
                                            title: 'Dynamic Site Creation',
                                            content: 'On-the-fly database configuration and site initialization during user onboarding'
                                        },
                                        {
                                            title: 'Visual Page Builder',
                                            content: 'GrapesJS integration for drag-and-drop page editing and component management'
                                        },
                                        {
                                            title: 'User Management',
                                            content: 'Admin panel with user role management and profile customization options'
                                        },
                                    ].map((feature, idx) => (
    ...
    └───utils`}
                            ...
                            <section id="api-reference" className="pt-12">
                                ...
                                <div className="space-y-8">
                                    {/* Authentication APIs */}
                                    <div>
                                        <h3 className="text-lg font-semibold mb-4 text-blue-600">Authentication APIs</h3>
                                        <div className="space-y-6">
                                            ...
                                            <div className="border rounded-lg p-6">
                                                ...
                                                <p className="text-gray-600 mb-4">Sets up separate databases for users and pages</p>
  ...
  "message": "Logged out"
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold mb-4 text-green-600">Content Management APIs</h3>
                                        <div className="space-y-6">
                                            {/* File Upload */}
                                            <div className="border rounded-lg p-6">
                                                <div className="flex items-center gap-2 mb-4">
