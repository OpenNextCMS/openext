...
export const ContactSimple = ({ block, isEditing = false }: BlockRendererProps) => {
  ...
  return (
    <section 
<<<<<<< HEAD
      className="text-[color:var(--color-muted,#4b5563)] body-font relative w-full" 
=======
...
<<<<<<< HEAD
                ...
                />
                <input type="text" id="name" name="name" className="w-full bg-[var(--color-surface,#f3f4f6)] bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-[var(--color-bg,#ffffff)] focus:ring-2 focus:ring-indigo-200 text-base outline-none text-[color:var(--color-muted,#374151)] py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
=======
...
<<<<<<< HEAD
                ...
                />
                <input type="email" id="email" name="email" className="w-full bg-[var(--color-surface,#f3f4f6)] bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-[var(--color-bg,#ffffff)] focus:ring-2 focus:ring-indigo-200 text-base outline-none text-[color:var(--color-muted,#374151)] py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
=======
                  className="leading-7 text-sm text-gray-600"
                  style={{ 
                    color: block.style?.color,
...
<<<<<<< HEAD
                ...
                />
                <textarea id="message" name="message" className="w-full bg-[var(--color-surface,#f3f4f6)] bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-[var(--color-bg,#ffffff)] focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-[color:var(--color-muted,#374151)] py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
              </div>
            </div>
            <div className="p-2 w-full">
              <EditableElement
                ...
                className="flex mx-auto text-white bg-[var(--color-primary,#6366f1)] border-0 py-2 px-8 focus:outline-none hover:bg-[var(--color-primary,#4f46e5)] rounded text-lg text-center"
...
>>>>>>> khadija
            ...
            <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
              <InlineEditableText
                ...
                isEditing={isEditing}
<<<<<<< HEAD
                className="text-[color:var(--color-primary,#6366f1)]"
                style={{ 
                  color: block.style?.color || 'var(--color-text, #111827)', 
=======
...
>>>>>>> khadija
              ...
              />
<<<<<<< HEAD
              <div className="leading-normal my-5" style={{ color: block.style?.color || 'var(--color-text, #111827)', fontFamily: block.style?.fontFamily }}>
=======
...
<<<<<<< HEAD
              ...
              >
                ...
                <a className="text-[color:var(--color-muted,#6b7280)]">
=======
...
<<<<<<< HEAD
                <a className="ml-4 text-[color:var(--color-muted,#6b7280)]">
=======
